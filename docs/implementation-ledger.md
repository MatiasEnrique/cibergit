...
| --- | --- | --- |
| Grok `thr_yiaxat4exz` | M4-REBASE-LIFECYCLE-R: H1–H3 and parent same-OID terminal-evidence correction. | `651037f5faadab3f9597f0a9c34c8ab17c8af3bc`; read-only root `env_nmjpff6eus`; `art_939a4e61-3bae-44e8-a8cd-2b9a35afb1da` / `av_9e61e7f4-5762-4e61-a8aa-440603b6008f` |
...
| Grok `thr_cww6z9nyyu` | M2-COMPARISON-CORE-R: exact identity/topology/baseline/pagination and direct-pair proof. | `eea5e9c1a77b73f82eacf75bab476a43adb1666f`; read-only `env_jdspi6iudz` comparison worktree; `art_60f12c44-01f5-47b4-931f-ebf4f4bfb526` / `av_75ac1f3d-c82f-4a05-95ee-9f0cafa0246e` |
...
| M2-PROGRESS | Full/commit/range/since-review selection and viewed progress; V08, R06 | M2 | G1, M2-REVIEW | Coordinator; Grok thr_cww6z9nyyu | running | Backend f80986a/export ef0a8d1 integrated; independent review and native selector pending | art_94e5138f-e6a3-47b0-88b9-a3be5c6d346d |
...
| M4-REBASE | Linear graphical plan, edit/split and dirty preparation; B01-B03, E14 | M4 | Accepted M3 backend; G3 for final native gate | Coordinator; Grok thr_yiaxat4exz | running | Lifecycle220cff1 and terminal651037f integrated; recheck/native plan pending | art_63cc3dbd-330a-43ae-a827-c4c6fe20b43e |
| M4-CONFLICT | Editable three-way result, external resolution and recovery; B04, B05, E14 | M4 | M4-REBASE, accepted Document backend; native M3-EXTERNAL | Coordinator; native UI unassigned | running | Lifecycle651037f recheck pending; widgets pending | art_63cc3dbd-330a-43ae-a827-c4c6fe20b43e |
