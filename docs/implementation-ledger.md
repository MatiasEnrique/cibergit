...
- Rebase core `30214fc` / export `76f8a0062494d79ccf08c0671d25d9ebd9b58ae2` passed 20 focused fixtures and parent combined tests, but independent review is **HOLD**: terminal operation blocks subsequent rebase, certain-prestart failures strand Prepared state, and split state can be bypassed by generic continuation. Verified report `art_9f6aab06-1c03-48b9-9169-5f2e21cd10aa` / `av_77e23231-76b3-43bc-93c2-15ec02ff9c06`. Corrections are running; no M4 acceptance is claimed.
...
| --- | --- | --- |
| Sol `thr_bwhywhdz3r` | M4-REBASE-LIFECYCLE: only rebase.rs/tests; safe archived retirement, no-dispatch retry, visible guarded split. | `e193ccc1f10d86ae9b64549d55d813742aee9442`; `env_vt3366mdig`; `/Users/matias/Development/cibergit-rebase-lifecycle`; `worker/rebase-lifecycle`; `art_8512598c-fa5f-41c0-a325-101a1bf49873` / `av_78b4bb75-555b-4fca-8c92-34380903c744` |
...
| Sol `thr_q2snxw6xjk` | M2-COMPARISON-CORE: new comparisons.rs/tests plus additive bounded provider reads; exact full/commit/range/since-review selection. | `f4658b2` (resolve full from brief); `env_jdspi6iudz`; `/Users/matias/Development/cibergit-comparison-modes`; `worker/comparison-modes`; `art_86a47e48-4bcb-448a-a941-a81a4a0c0ccd` / `av_0a6a1b4e-bfd1-4165-9c33-e3c96f04f565` |
...
| M2-PROGRESS | Full/commit/range/since-review selection and viewed progress; V08, R06 | M2 | G1, M2-REVIEW | Sol thr_q2snxw6xjk | running | Existing full/viewed; exact selection backend underway; native selector pending | art_86a47e48-4bcb-448a-a941-a81a4a0c0ccd |
...
| M4-REBASE | Linear graphical plan, edit/split and dirty preparation; B01-B03, E14 | M4 | Accepted M3 backend; G3 for final native gate | Sol thr_bwhywhdz3r | running | Backend76f8a00 HOLD; lifecycle correction running; native plan pending | art_9f6aab06-1c03-48b9-9169-5f2e21cd10aa |
| M4-CONFLICT | Editable three-way result, external resolution and recovery; B04, B05, E14 | M4 | M4-REBASE, accepted Document backend; native M3-EXTERNAL | Sol thr_bwhywhdz3r core; native UI unassigned | running | Backend76f8a00 correction/recheck pending; widgets pending | art_9f6aab06-1c03-48b9-9169-5f2e21cd10aa |
