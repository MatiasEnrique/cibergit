...
| --- | --- | --- |
| Sol `thr_s8bnx42xb4` | M4-NATIVE-REBASE: plan and local lifecycle controls within LocalWorkspace; exact editor/operation interlocks. | `33d2a192` (resolve full); `env_22vkavrwgj`; `/Users/matias/Development/cibergit-native-rebase`; `worker/native-rebase`; `art_75f74857-3880-4610-b7b9-88146ea7327a` / `av_b7d1f255-2379-43d7-b605-c22e285d3bdd`; support `5eac1f7` |
