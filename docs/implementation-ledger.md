...
| Sol `thr_hs8k2a8rgv` | Attachment verification and conservative managed cleanup | `/Users/matias/Development/cibergit-native-checkout-cleanup`; `art_be9f7d23-a611-42b9-88de-112673d40312` / `av_940306be-d8ea-47a1-8831-eb7f5efa70c9` |
...
| M1-SYNC | Polling, explicit revision advancement and offline read; S01-S04, R04, E09 | M1 | M1-DIFF, M1-SIDEBAR | C0 | running | Canonical pinning and read lifetimes accepted; bounded read admission 3b00b04 tested; offline/conditional polling frontier open | Read-admission report above; G1 evidence pending |
