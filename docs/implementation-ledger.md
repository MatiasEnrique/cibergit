...
Integration branch: `integration/v1`. The application opens real PRs, supports native inline review controls, and opens persistent local workspaces without advancing the displayed review. M0 is proven; G1–G5 remain open. Acceptance applies only to the scoped evidence below. Full historical commits and reports remain in coordinator state artifact `art_4093b33c-94aa-410e-88b3-3ff83175ee7e` (revision 21 and successors).

- Foundation: exact compatible GPUI Base 0.6.1 / GPUI 0.3.1 runtime-shader family, MIT/notices, macOS 15 arm64, IBM Plex Sans and native material direction. M0 report `art_38b8ddbc-509d-449c-bab5-85e11a1c88e4` revision 2 and upstream audit `art_6e2ffc7c-6d8e-48e4-9c32-a21d024287ee` are verified.
- Provider/account, immutable review and persistence foundations are integrated. Provider correction `56662a3` is independently accepted in `art_486e91ad-c526-4f46-b562-c7bc4e31da92` / `av_83d59727-e2f5-4faf-8057-8d85a92edb7c`. Account-bound acknowledgements, bounded concurrent process I/O and no automatic replay are retained. Unsafe branch deletion remains unavailable; broader PR inventory is incomplete.
- Native sidebar, saved views, file tree, adaptive diff and horizontal clipping are integrated. Earlier combined real-read light/dark evidence: `art_bafcbb2c-99d3-45ff-8a4f-286231f707a1` / `av_5769c237-37b6-4ac8-918a-2bd0178883b2`. Full/commit/range/since-review native selectors, broader sync/offline acceptance and physical input remain open.
- Native discussions and review confirmations: source `0dde8167b5681c53eed4162199b12bc839bc0b5d` + `aaa1c17e8ec21e280ffac6fee805d0173bde9c92` integrated as `31672ac` + `22a4d15`. Variable-height inline discussion/composer, pending/immediate/submit and merge controls, per-key cross-process authority/CAS, durable auxiliary/merge journals and Markdown code preservation are implemented. Worker report and all 26 evidence files verified: `art_25a4a81b-bb27-4e01-83ea-423c7ddc5ab5` / `av_966d111e-1848-4ff7-9809-179e7dcb4435`. Parent integrated 256 tests passed, 0 failed, 7 intentional ignores across 18 suites; strict Clippy passed. Independent native audit HOLD: the DraftStore review operations lack their own read-only reconciliation route; correction is running. Report `art_0db0d89f-2900-4ad3-845e-eba300bbe02d` / `av_93b695d5-8cb0-4e28-aa4f-8225d7f05425`. Native reads/fixture action paths do not establish authorized live publishing.
- Document and LocalGit backends remain accepted at `11a3a8e` / `d138c7c`: `art_3e0be915-12bf-4e65-83e6-d0f9d7497cca` / `av_1df8c8ce-f167-4c14-b330-62ff319dde65`. Worktree identity/provenance at `85af97c` accepted in `art_f3fd1bca-80c8-490e-8af6-64325190b1a7` / `av_fd1b8438-8041-4ee7-831e-2ea6af642900`.
- Local editor correction `e193ccc1f10d86ae9b64549d55d813742aee9442` from `ced6f0a823400521d1baecb74b71aa4b26ad3117` closes nested Git metadata exposure, unbounded/following directory traversal, pre-start freeze, no-op refresh confirmation and stale crash lock. Independent ACCEPT: `art_dba381fa-731c-42c1-ba6d-86da28dd4fab` / `av_a704fcc6-e83a-4c16-83b2-836064ff6807`; source report `art_8e6ecf81-7b23-4cc7-8c36-25085063110e` / `av_2ff009e8-5926-4601-b750-c5ca87959a1a`. Residual: a failed exact journal clear after a certain refusal may require restart to re-read the retained record; no record is erased.
- Parent PR LocalCheckout embedding `a69cc54`, network provisioning bound `909f5c3`, shortcut/lint integration `384fa55`, and retired direct-write prototype `f4658b2` are integrated. Real `cli/cli#14130` fresh light creation and dark restart reused a dedicated checkout, opened the selected file, and returned to the same published Revision/file. First 30-second clone timeout was preserved as incomplete evidence; explicit clone/fetch now have a 180-second deadline. Reconciliation never repeats an incomplete operation. Verified integrated review/local evidence: `art_0a89eee9-f27c-4ced-b637-79d9a1c13895` / `av_604db5a1-9a4c-4dc7-838b-916de425c7a4` (21,700,672 bytes); attach/recovery/cleanup and PR-target publication acceptance remain open. Fork-source read support `304a2b9` report: `art_c0c64c56-6624-4a27-a9f7-60de56e9d87c` / `av_13bda946-b212-436c-9a2d-fa9b9a815299`.
- Rebase lifecycle correction `e11179f763ff2d4e42d0eea7cc29c3d7aad520f9` integrated as `220cff1`. Safe archived retirement, certain-no-start recovery and visible guarded split close the original three findings. Parent broader tests exposed an additional same-OID completion misclassification. Correction `651037f5faadab3f9597f0a9c34c8ab17c8af3bc` uses exact terminal HEAD reflog evidence and preserves verified historical outcomes; 23 focused tests and strict scoped Clippy pass. Independent scoped ACCEPT: `art_b0e7ca6b-153f-4d77-a24d-66439823e8b7` / `av_a6c2a0a7-3e50-4854-a115-4e6dcdc0bb89`. Combined rebase/comparison suite 271/0/8 ignored and strict all-target/all-feature Clippy passed. Source report `art_63cc3dbd-330a-43ae-a827-c4c6fe20b43e` / `av_101c4ba6-e8e6-407a-9422-f1df92c6726a`. Split abort includes `reset --hard` to the recorded edit stop: it can discard obstructing untracked paths, which future native confirmation must disclose. No M4 acceptance is claimed.
- Comparison backend `eea5e9c1a77b73f82eacf75bab476a43adb1666f` integrated as `f80986a`, exported by `ef0a8d1a93648c38829232743f318bd23a6c8c8f`. Full, sole-parent commit, contiguous range and explicit since-review selection keep canonical PR revision separate from selected pair. Local divergence is an exact tree diff; unprovable remote pairs fall back with reason. Source report `art_94e5138f-e6a3-47b0-88b9-a3be5c6d346d` / `av_a1253590-6fd6-4f9a-9e99-97780ec7eac6`, manifest/full report verified. Worker 248/0/7 ignored and public exact 16-file commit read passed; parent combined tests 271/0/8 ignored and strict Clippy passed; scoped independent ACCEPT `art_677071aa-be13-4de7-a2a1-2e6117912aba` / `av_b5b27b1f-9eab-4c71-8fb7-e3177dd77f9a`. Native selector remains unimplemented.

- Native DraftStore reconciliation `ce8089933da6908de3c0385cc47c7528f1412102` integrated as `7b2e310db9456b6c4e79160a83d4e6fe6a5eb06f`: exact known comment/review ID proof under shared authority/CAS, durable save before success, separate review/auxiliary counts, no body guessing or absence-based retry. Parent full suite 280/0/8 ignored and strict Clippy passed. Source/evidence `art_a732905c-fe1a-49e9-87a1-c883c6c7b160` / `av_90686dce-bbb9-4f31-9218-853e6f07a230` verified all seven files. Independent recheck confirms a production-shape HOLD: pending-review reads always omit comment side, while reconciliation required it. The synthetic success fixtures incorrectly supplied side. Sol is joining the exact pending comment ID to unique complete detail-thread coordinates, retaining all identity/completeness checks; production-shaped tests and final compact/expanded native scenes are required before acceptance. The existing 280-test result does not close this HOLD. Parent visual inspection also requires compact default recovery messages, full details disclosure and wrapped inspector actions.
- Native rebase UI is assigned to Sol `thr_s8bnx42xb4` in the isolated LocalWorkspace component. Parent `5eac1f763bcd9838be524acb50ebd16f7f6554d2` adds bounded read-only explicit HEAD/full-ref/OID resolution for the base picker; 16 LocalGit tests and strict scoped Clippy pass. No automatic ref movement or fetching.

- Development packaging `8709527`: Cargo-resolved arm64 output, new-path bundle creation, version/provenance/notices, ad-hoc local signing and file manifest. Packaged native launch reused the saved PR local workspace and preserved Review. ZIP extraction, all-file hash readback and strict signature verification passed. Verified checkpoint `art_4ad60d61-6787-4357-8dd9-36a0affe941c` / `av_1de35218-baab-4005-a813-65fce04f76d8` (23,300,290 bytes). This development-profile bundle explicitly includes opt-in smoke support; final icon, macOS 15/Finder/distribution launch, Developer ID and notarization remain open.

- Optimized package checkpoint: `a401860e7310f9d5daa8900cea385495f14e4622` integrates the named host-macro Cargo profile override from clean validation source `f3cec8ba61c1e8e9bce5090f8cffc4f01b89ec84`. It fixes pinned gpui-pre-macros 0.3.1 release compilation without enabling application debug assertions or smoke support. Release build, extracted seven-file manifest/hash verification (28,384,110 bytes), arm64/macOS 15 deployment metadata, strict ad-hoc signature and CLI passed. Verified report/ZIP artifact `art_5d45f3c0-34d0-45fb-950b-91159d7abc51` / `av_7ca15477-7651-4262-ad5c-804d46cd2799` (8,365,777 bytes). This checkpoint contains the unresolved native reconciliation revision; it is not a V1 release candidate, GUI proof or signed/notarized distribution. See [release profile](release-profile.md).

- Native reconciliation correction is now independently ACCEPTED at `c3bb8bd1ec909473d7ae9f850ee92a768e7a4ad0` (presentation `fb9b5d2`; worker `cb96839d1eb241aba7215399b129eef88f0f3f75` + `46a61141e654e6433e26d12b3783e1b1cd2f0443`). Production `pending.side=None` joins exact IDs to a unique complete current detail thread for side/range proof; unknown IDs remain unresolved. Parent integrated 281/0/8 ignored, default and all-feature strict Clippy, and fresh dark restart passed. Native scenes use synthetic discussions on real public reads, with no sends. Worker artifact `art_a732905c-fe1a-49e9-87a1-c883c6c7b160` / `av_76b87d5d-025d-4190-9553-e3daf912846d`; parent evidence `art_a629f545-7fd7-4618-83df-82089c2ef76d` / `av_1480670e-eec2-4409-b182-dbfd144b04fd`; independent ACCEPT `art_fbf76bd0-798c-41fa-8fd2-a8cfcd0ec669` / `av_174fdaac-d17a-4e71-bf8d-59d997d4e0b3`. All manifests and complete reports verified. This closes the two scoped reconciliation findings, not all M2.

- Native rebase checkpoints `0ff507aa9a863089072c05c2f8d95e846c592840` and `fafc1aa68b7b8935036b63cff87c5d4599728114` are integrated as `33a27ab` and `916822a`. Plan, edit, conflict, stash and terminal controls run through accepted backend APIs with editor/action interlocks. Parent combined tests: 297 passed, 8 ignored; strict all-feature Clippy passed. The integrated light native fixture completed plan/edit/continue/archive/conflict/abort and existing editor checks. Final compact operation-details disclosure and an instrumented same-branch smoke follow-up are still with the worker; independent component review remains pending. Full three-way conflict presentation and verified PR-source publishing are separate required follow-ups.
- Worktree store authority correction `8991f51e33894fa47ddd995c4d83ca124e06be46` adds bounded cross-process descriptor-held locking around existing association/provenance read-modify-write operations. The persistent private lock inode survives process death while its OS lock releases; no automatic replay or schema change. Focused tests: 20 passed, 1 helper entry ignored; strict scoped Clippy passed. Removing the OS lock makes the contention regression fail. Verified report `art_19102915-d42c-414f-9de5-89c36cc7cd08` / `av_2410ea5e-12c4-429a-ab35-29498c2b2635`. Independent review remains pending.

- Final native rebase follow-ups `e5016a0a871ac2e32af53478860931dc8f0a9eee` and `ab0e4fb745ccf2f4e409f0641288886e27d2316b` are integrated as `1bc5925` and `0593f76`. Parent focused 27/0/1 helper ignored, strict scoped Clippy, and fresh dark native smoke passed. All explicit CreateBranch, real SwitchBranch and same-current SwitchBranch probes completed with authoritative branch state. An earlier unclassified worker switch failure and retained journal remain recorded; passing reruns do not classify it. Verified worker artifact `art_eff4ed34-c444-4a63-849f-5ce8ce7fbba3` / `av_7c153c61-3afa-4331-8f25-c7b2067d0088` (24 files, 6,138,079 bytes); parent proof `art_5da93e78-86b4-4e58-8a33-f4edbd601560` / `av_451cc9e2-8e83-4cd3-9454-853d3a0a5328` (seven files, 701,968 bytes). Grok `thr_wv5dfskzhn` is reviewing the native component and bounded worktree-store authority delta separately; no scoped acceptance yet.
- Original native app icon `500ac49f059306ac5b3b8654abeceb0e715b78ed` is bundled via `CFBundleIconFile`, with an AppKit source recipe and standard ICNS representations. A development bundle with smoke support passed all eight manifest hashes, exact icon readback, plist and strict ad-hoc signature validation. Verified artwork/report/manifest `art_317f0cb4-f297-4028-a530-a12c02a25ae1` / `av_2791c8ea-e9f1-4352-8f1b-30a427965c5e`. This is not final release, Dock/Finder or distribution acceptance.

Active assignments, all native BB members of `proj_z2zyatsrbn`:

| Worker | Scoped deliverable | Base / environment / worktree / brief |
| --- | --- | --- |
| Grok `thr_wv5dfskzhn` | Independent native rebase component and bounded worktree-store authority review. | Exact source `0593f76` (resolve full); read-only `env_nmjpff6eus`; brief `art_12fcef00-d139-4e02-8ca7-f0362455a29a` / `av_8ce8cd79-4b66-4f94-8e04-0f302c2210ec`. Native Sol handoff consumed and archived. |
| Sol `thr_c7u2unug7u` | M2-NATIVE-COMPARISONS: canonical/selected revision separation, native selectors and atomic progress persistence. | Base `c3bb8bd`; env `env_c3pkdwtvvg`; `/Users/matias/Development/cibergit-native-comparison-selectors`; brief `art_44ac78cf-3d5c-4f67-b02d-61bf0d337e94` / `av_3153c73c-0912-4d3a-824b-fdd6a8ddcdce`. |
| Sol `thr_h26wwdd2ta` | M2-PR-LIFECYCLE: provider metadata, lifecycle, top-level discussion and separate PR creation. | Base `c3bb8bd`; env `env_bsi33m3qhb`; `/Users/matias/Development/cibergit-pr-lifecycle`; brief `art_d289a61c-7910-4ea4-afdc-9e565e70edd7` / `av_3077add0-8be5-4747-aac0-3dbaeba437d6`. |

Consumed workers and reviewers are archived/stopped. Writable Cargo targets are isolated. User preview PID 43840 remains running with its original data untouched. No real remote writes, settings/auth changes or permission changes were made. Signing, oldest-OS and physical input/Accessibility evidence, designated live-write targets and Q60–Q66/Q68 remain later explicit gaps; they do not stop independent implementation. Net remaining unmerged stack diff remains required and unimplemented.
...
| M2-DISCUSS | Inline threads and Overview/Activity content; V03, R01 | M2 | G1 | Coordinator; Sol thr_2g8vkvihfj | running | Native31672ac/22a4d15 integrated; outcome reconciliation correction running | art_25a4a81b-bb27-4e01-83ea-423c7ddc5ab5 |
| M2-REVIEW | Pending/immediate comments, draft recovery, explicit submission; R02, R03, R05, E10 | M2 | M2-DISCUSS, M1-STATE | Coordinator; Sol thr_2g8vkvihfj | running | Backend9e6e65a/56662a3 accepted; nativec3bb8bd reconciliation independently accepted; remaining native scope open | art_25a4a81b-bb27-4e01-83ea-423c7ddc5ab5 |
| M2-PROGRESS | Full/commit/range/since-review selection and viewed progress; V08, R06 | M2 | G1, M2-REVIEW | Sol thr_c7u2unug7u | running | Backend f80986a/export ef0a8d1 independently accepted; native selector pending | art_94e5138f-e6a3-47b0-88b9-a3be5c6d346d |
| M2-PR | PR lifecycle, metadata, reviewers and checks; F07, R07 | M2 | Accepted provider; G1 for final gate | Sol thr_h26wwdd2ta | running | Backend lifecycle assignment; native UI pending | art_d289a61c-7910-4ea4-afdc-9e565e70edd7 |
| M2-MERGE | Current-head requirement and explicit merge controls; R08, R09, E10 | M2 | M2-REVIEW, M2-PR | Coordinator; Sol thr_2g8vkvihfj | running | Backend56662a3; native confirmation22a4d15; shared uncertainty correction running | art_25a4a81b-bb27-4e01-83ea-423c7ddc5ab5 |
...
| M4-REBASE | Linear graphical plan, edit/split and dirty preparation; B01-B03, E14 | M4 | Accepted M3 backend; G3 for final native gate | Sol thr_s8bnx42xb4 | running | Lifecycle651037f independently accepted; native plan running | art_63cc3dbd-330a-43ae-a827-c4c6fe20b43e |
| M4-CONFLICT | Editable three-way result, external resolution and recovery; B04, B05, E14 | M4 | M4-REBASE, accepted Document backend; native M3-EXTERNAL | Sol thr_s8bnx42xb4 lifecycle; three-way editor pending | running | Lifecycle651037f accepted; native conflict routing running | art_63cc3dbd-330a-43ae-a827-c4c6fe20b43e |
