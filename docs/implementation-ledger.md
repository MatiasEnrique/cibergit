...
The full PR feature inventory draft is banked in `art_2adccd06-cc44-4998-8c01-e5795eae331e` / `av_a3526df9-915c-44fb-9a13-207521abe28c`. This records API-backed gaps, not Q65 approval or a scope reduction. Native creation, file-level comments, published review controls, reactions and broader CI/job/log actions remain open.

Active native BB assignments:

| Worker | Deliverable | Base / workspace / brief |
| --- | --- | --- |
| Sol `thr_b8gwrbip7e` | Verified PR-source destination, Publish/Republish and lease confirmation | `b932fc7`; `/Users/matias/Development/cibergit-pr-source-publish`; `art_969afae9-ffcd-44cd-a2db-1780ca5427d6` / `av_fb00599a-e823-4427-855d-f0ce447759e0` |
| Sol `thr_bhwcx88fn5` | Exact provider notification evidence and personal unread store | `f1a994f`; `/Users/matias/Development/cibergit-notifications-core`; `art_d6caace9-0c6f-4045-8a38-bcb5794bb18d` / `av_53cd6b5b-cec4-4ddc-8ac2-eb5391688037` |
| Sol `thr_uv2pauvq4f` | Separate read-only stack net view, provenance and personal corrections | `c933f3e`; `/Users/matias/Development/cibergit-native-stack-view`; `art_ae95e0c1-5760-4885-bd4d-a257ce415efc` / `av_d88fd911-7b10-41ce-9ee5-d89fe2d3d7f4` |

Consumed lifecycle, three-way and stack workers/reviewers are archived/stopped. Preserve original preview PID 43840 and its state. No live remote writes or auth/global changes. Native creation, notification delivery/sync, publish/cleanup and full PR inventory remain required. Q60–Q66/Q68 and external signing/physical-input/live-write gates remain explicit; they do not stop independent implementation. Native stack scope handles unambiguous linear paths while Q60 remains unanswered; it does not choose a multiple-tip policy.
...
| M2-NOTIFY | Personal unread state and opt-in system notifications; S05 | M2 | M2-DISCUSS, M2-PR | Sol thr_bhwcx88fn5 | running | Evidence/store implementation; native delivery pending | Brief above |
...
| M4-PUBLISH | Inspect rewritten commits, explicit lease-protected push; B06, E15 | M4 | M4-CONFLICT, M3-GIT | Sol thr_b8gwrbip7e | running | Verified destination and native confirmation underway | Brief above |
