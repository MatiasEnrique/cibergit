...
| --- | --- | --- |
| Sol `thr_76zz49fsqg` | M2-PROVIDER-ACTIONS: providers.rs, tests/provider_actions.rs and additive domain models. Persist exact InFlight review payload before dispatch; no retries; guarded pending review, discussion and merge actions. | `5d3c32b3b90cb3c1f3ea1a4e90071423415d5fe5`; `env_zu43kn85s5`; `/Users/matias/Development/cibergit-provider-actions`; branch `worker/provider-actions`; brief `art_a3a17d54-e9dc-48f9-a79b-2e5d5226ce3f` |
...
| M2-REVIEW | Pending/immediate comments, draft recovery, explicit submission; R02, R03, R05, E10 | M2 | M2-DISCUSS, M1-STATE | M2-REVIEW-CORE assignment above | running | Backend accepted at 9e6e65a; executor running; UI pending | Brief above; acceptance pending |
