...
Two material source HOLDs remain and are under correction. Publish recovery must observe the persisted exact attempt destination/configuration, rather than re-prepare a changed current PR (`art_2fab39e5-a07d-456b-a523-bd0e73076bfb` / `av_c8abb32c-110c-43da-949d-3d00b2933a08`). Notifications must skip valid non-PR subjects without blocking PR baselines and obey the endpoint page-size contract (`art_57a400a6-7bbb-40c0-9bb9-01d065c02515` / `av_6c84e85f-5f56-4909-8f77-a10be238df76`). Neither passing suite nor visual proof closes these source findings. Historical unclassified worktree-hook and same-current-branch incidents remain disclosed.

Active native BB assignments:

| Worker | Deliverable | Base / workspace / brief |
| --- | --- | --- |
| Sol `thr_2v3kfhzsmw` | Exact journaled publish recovery and non-force drift proofs | `f634dda`; `/Users/matias/Development/cibergit-publish-recovery`; `art_0617f1b0-7cb6-4fd0-8fed-aff3eca4b8a4` / `av_9d19198f-00fc-4468-915b-ffdd46c90bca` |
| Sol `thr_qiv5cnjysy` | Complete PR notification enumeration with safe page/type handling | `f634dda`; `/Users/matias/Development/cibergit-notification-enumeration`; `art_b4dca2a5-cd82-4394-b6ac-488d6bfaf44f` / `av_218ce29e-f99c-4b45-9528-898f7bfa6487` |
...
Consumed implementation/review workers are archived/stopped. Preserve original preview PID43840 and its state. No live remote writes or auth/global changes. Native creation, notification delivery/sync, publish recovery/cleanup and full PR inventory remain required. Q60–Q66/Q68 and external signing/physical-input/live-write gates remain explicit; they do not stop independent implementation. Native stack scope handles unambiguous linear paths while Q60 remains unanswered; it does not choose a multiple-tip policy. Parent source review requested unique stack-controller lifetime admission and asynchronous personal-correction persistence before worker completion.
