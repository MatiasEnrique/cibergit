...
- Development packaging `8709527`: Cargo-resolved arm64 output, new-path bundle creation, version/provenance/notices, ad-hoc local signing and file manifest. Packaged native launch reused the saved PR local workspace and preserved Review. ZIP extraction, all-file hash readback and strict signature verification passed. Verified checkpoint `art_4ad60d61-6787-4357-8dd9-36a0affe941c` / `av_1de35218-baab-4005-a813-65fce04f76d8` (23,300,290 bytes). This development-profile bundle explicitly includes opt-in smoke support; release profile, final icon, macOS 15/Finder/distribution launch, Developer ID and notarization remain open.
