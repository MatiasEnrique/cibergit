...
M1-SYNC-NOTIFICATION-CONDITIONAL is running under `thr_ueig6wyexv`, branch `worker/conditional-notifications`, worktree `/Users/matias/Development/cibergit-conditional-notifications`, base `3976f9d3f6d75406e4e61949ee7385ff9ce3e8b4`. Verified discovery `art_e8743ef0-0093-46ec-a7ed-a4af47db329b` / `av_19a308cd-c55f-4f4d-b7b4-de90a9ac10e6` supports exact in-memory validator/body caching and server polling gates. Cached notification discovery must still receive fresh event hydration; partial batches may preserve independently fresh alerts for already-baselined repositories. File-level comments, dismissal, general conditional sync and broader offline behavior remain follow-on work. No Q65 or other unanswered policy is approved by these assignments.
...
| M1-SYNC | Polling, explicit revision advancement and offline read; S01-S04, R04, E09 | M1 | M1-DIFF, M1-SIDEBAR | C0 | running | Cache and ordinary saved-tab startup accepted at dcd2e94, including all-gh-refused light/dark; conditional polling and broader offline proof open | art_390149a0-6f08-4364-9412-a15907496fd8 / av_31d63147-a661-447a-abdd-c3bd264f97d3; G1 pending |
...
| M2-NOTIFY | Personal unread state and opt-in system notifications; S05 | M2 | M2-DISCUSS, M2-PR | Coordinator | running | Store/enumeration and bounded native UI/consent/body-mention accepted; comment/team, conditional caching and physical delivery open | Notification integration and independent reports above |
