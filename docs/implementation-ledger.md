...
| Sol `thr_2g8vkvihfj` | M2-REVIEW-RECONCILE: app/controller exact evidence reconciliation for frozen DraftStore operations; no body guessing or replay. | `8709527a8504a0a01a63a733eb576e1de26e6889`; `env_ye4nrdwt22`; `/Users/matias/Development/cibergit-review-reconciliation`; `worker/review-reconciliation`; `art_e5d9e319-aacb-4a4d-9a27-5765deb47f50` / `av_82ee83ab-e507-416b-9d4a-4b116e026417` |
| Grok `thr_7erer9nc6a` | M2-REVIEW-RECONCILE-R: exact read-only proof/CAS/durable result and native route, final presentation delta follows. | `7b2e310db9456b6c4e79160a83d4e6fe6a5eb06f`; read-only root `env_nmjpff6eus`; `art_50c14a88-cfff-4346-b933-1dbf39062751` / `av_dd2ba1f3-8664-4277-bd70-439a82f9f505` |
...
| M2-REVIEW | Pending/immediate comments, draft recovery, explicit submission; R02, R03, R05, E10 | M2 | M2-DISCUSS, M1-STATE | Coordinator; Sol thr_2g8vkvihfj | running | Backend9e6e65a/56662a3 accepted; native22a4d15 reconciliation HOLD correction running | art_25a4a81b-bb27-4e01-83ea-423c7ddc5ab5 |
| M2-PROGRESS | Full/commit/range/since-review selection and viewed progress; V08, R06 | M2 | G1, M2-REVIEW | Coordinator; native selector unassigned | running | Backend f80986a/export ef0a8d1 independently accepted; native selector pending | art_94e5138f-e6a3-47b0-88b9-a3be5c6d346d |
