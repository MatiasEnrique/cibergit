...
Remaining PR control discovery is complete in `art_df341191-3f50-4465-9654-a605949bb79a` / `av_3e58c927-2172-4154-b756-0d5229368aee`. M2-REACTIONS is accepted at integrated source `65774c66502cf4b58a3e29d5901a7773d0b90988`, including worker `2ed7e744b9f053578a9a0ea0822f91b84acf3724` and the parent shared pending-comment decoder correction. Native Buttons cover PR, submitted review, discussion comment and every displayed review comment; cached history remains read-only. Fresh selected-viewer preflight, exact journal/acknowledgement and stale-callback fences are independently accepted. Parent exact-source checks, default 584/0/13, all-feature 641/0/14, both strict Clippies, formatting and native build pass. Parent light/dark reactions and five-phase offline restart pass; worker named mutations and actual native stale-apply failure are retained. No live mutation, physical input, OS notification or focus claim. Parent packet `art_ed1ab8b8-74f1-470a-87c3-9a00e86477aa` / `av_0d01407d-38d7-4807-b1ec-5205a9e8ad54` has 109 files / 28,046,140 bytes, manifest `cc572509f1ff3fb47be80d8702f2d63be4f739a8319475a142e3ca41e5064f71`; full manifest, untruncated REPORT read and fresh-download sizes/hashes/no extras are verified. Removal has no server-side expected-reaction-ID condition; a final preflight cannot eliminate the intervening remove/re-add race, and ambiguous acknowledgement remains Uncertain. Dismissal was the next implementation slice at that checkpoint and is accepted below. No-existing-pending flow and the broader PR/CI inventory remain open. Q65 and other unanswered policy are unchanged.

## Submitted-review dismissal and Checks checkpoint, 2026-09-14

Integrated source `773f1db0c10ad7e6b717b7ee2ba88783834b198d` is accepted for this bounded slice. Dismissal freezes the review and reason, records the exact request durably, repeats the provider preflight, and validates the acknowledgement before recording a compact receipt. Cancel and edited-reason rejection preserve text; input entity and completion generations protect tab transitions. Unknown outcomes never replay. Administrative evidence and the explicit GitHub-decides path remain separate. This does not resolve Q65 or authorize a live write.

Checks retain exact PR, repository, commit, suite and workflow/run/attempt identities. Partial data stays incomplete; names and URLs never infer Actions linkage. Historical cache validation rejects malformed, duplicate and foreign identities while preserving the record. Native Button controls expose selected/expanded/disabled state and support pointer and keyboard navigation through every enumerated check. Long titles wrap, and expanded Actions metadata remains reachable by scrolling.

Independent review closed the dismissal findings at worker `1da7b5e`, the five Checks finding families at worker `4ae8b194`, and the combined source carry at parent `72f6da7`. The final default-derive, title-layout and smoke-continuation changes received bounded parent source review. Locked full suites passed at `1c850dbc055e23126908977ac7a943a3ca8b717a`: default **616/0/13 ignored**, all-feature **680/0/14 ignored**. At final `773f1db`, both locked all-target checks, both strict all-target Clippies, formatting, the affected provider and native-control tests, and the native build passed. Full suites were not repeated for the final small changes.

Parent light/dark dismissal and Checks runs passed at `773f1db`; all 12 captures were individually inspected. Five closed-PR restart phases also passed, including no-argument mixed offline and all-gh-refused light/dark runs. Eight restart captures were inspected. Named source mutations discriminate administrative-authority propagation, dismissal notification/stale completion, and duplicate cached check admission. Failed historical builds, the obsolete test-message failure, and restored passes are retained. No live mutation, physical input, OS notification or focus request was performed.

Verified parent packet: `art_b884d7b6-d3e8-4fd4-81c0-8f2378b5c1af` / `av_dfe2943b-0121-4b72-af47-ed4127e4f1c7`, manifest `aca8d3f5f11d7b95d8e7204d9026bb45523bf77315d3bab044606cb5a6300f66`. All **144 files / 38,546,131 bytes** matched the published manifest and fresh download, with no extras. The full REPORT readback was untruncated, 10,362 bytes, SHA-256 `6ba5bccb64da94204e5f642a265f379264077b5d605220b838dd3bf948147ef6`. It includes exact source, raw checks, worker and independent reports, mutation results, and native/restart evidence.

The provider has no server CAS after dismissal preflight. Later DISMISSED state alone cannot prove the reason or causation. Predispatch reasons remain memory-only, and oversized journal requests refuse before transport. The next implementation slice is attempt-specific Actions jobs and bounded logs. Starting a pending review with a FILE comment remains under discovery. Full M2/V1, G1–G5, unanswered Q60–Q66/Q68 and release acceptance remain open.
...
| M2-PR | PR lifecycle, metadata, reviewers and checks; F07, R07 | M2 | Accepted provider; G1 for final gate | C0 | running | Native lifecycle ce36e23, submitted edit a73d7f9 and durable drafts/known-pending FILE664e30f and four-subject reactions65774c66 accepted; dismissal and exact Checks773f1db accepted; broader PR/CI inventory pending | Integrated lifecycle evidence above |
...
| V04 | A fresh review opens unified at any width; Auto and side-by-side remain selectable and a selected mode is remembered; P review workspace, Q16, Q26, user instruction 2026-09-14 superseding the width-dependent default | M1-DIFF | Open a fresh tab wide and observe unified; select Auto and resize across the split threshold; select side-by-side and restore it across navigation/restart. |
