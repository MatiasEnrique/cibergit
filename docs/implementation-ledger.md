...
Unsent submitted-review text still exists only in per-tab memory before dispatch and is lost on tab close/restart. The action journal becomes durable at dispatch, which does not close that separate gap. M2-SUBMITTED-DRAFTS is running under `thr_r2zppyvgkj`, branch `worker/submitted-review-draft-persistence`, worktree `/Users/matias/Development/cibergit-submitted-review-drafts`, base `a73d7f9f369caebb14f792f572af99965be96211`. Scope is bounded private draft storage, account/review identity, concurrent-save/clear protection and safe background load/save UI admission; fresh capability and transport stay unchanged.
...
Parent packet `art_7b5f0f92-193d-490b-80aa-5a0584f3e0c6` / `av_bf6eba8f-5187-4e71-a620-7db2651b9f28` contains 53 files and 1,606,195 bytes. Manifest, full report and fresh-download size/SHA verification passed. Worker report `art_325fb2da-a377-453d-982d-f77503ccc9cd` / `av_653ed92e-acd3-4694-9952-995ff46eef88` links the separately verified source, focused/mutation logs and native packets. The worker and reviewer are consumed and archived. General conditional sync, comment/team mention evidence and physical OS delivery remain open.

Submitted-draft source `ef669279a9a20f27bd0203f7a369cad77c74aebe` remains unintegrated. It corrects the earlier root-path and read-bound defects, per-review clear and conflict merging, and save/clear sequencing. Two source HOLDs remain: synchronous tab transitions discard their supplied GPUI window and can silently skip shared-editor restoration, and conditional-install rollback/cleanup error paths omit directory fsync. Parent and independent review agree on the window defect. Report `art_c282be7e-fa6c-44e7-92ca-327aa4c140c2` / `av_e00a3948-3771-4dbe-ab4f-4d438bb2d9b8` was shown, fully read and hash-verified. Worker focused tests and mutations are supplied evidence; no parent broad or native acceptance applies to this pin. Corrections must exercise actual window transitions and durable rollback before integration.

Known-pending file-level comments are being implemented independently by `thr_42gg8xqx3a` from `2cf6fd80baf0cee9d21294c6f0c4a0be65a3d907`. This scope permits one exact FILE-thread mutation against an existing, freshly validated pending review; it does not create a pending review or fall back to immediate publication. Its shared-editor additions must be integrated with the submitted-draft transition correction. The no-existing-pending workflow and dismissal authority remain separately unresolved. No Q65 or other unanswered policy is approved by these assignments.
...
| M1-SYNC | Polling, explicit revision advancement and offline read; S01-S04, R04, E09 | M1 | M1-DIFF, M1-SIDEBAR | C0 | running | Cache and ordinary saved-tab startup accepted at dcd2e94, including all-gh-refused light/dark; conditional notification polling accepted at2cf6fd8; general conditional/offline proof open | art_390149a0-6f08-4364-9412-a15907496fd8 / av_31d63147-a661-447a-abdd-c3bd264f97d3; G1 pending |
...
| M2-PR | PR lifecycle, metadata, reviewers and checks; F07, R07 | M2 | Accepted provider; G1 for final gate | C0 | running | Native lifecycle ce36e23 and submitted edit a73d7f9 accepted; unsent edit persistence and broader PR/CI inventory pending | Integrated lifecycle evidence above |
